import { ADD_TO_CART, LOADING_FALSE, LOADING_TRUE, REMOVE_FROM_CART, SAVE_SHIPPING_INFO, UPDATE_CART } from "@/lib/features/cart/cart"
...
export const save_shipping_info = (shipping_info) => async (dispatch, getState) =>{
  dispatch(LOADING_TRUE())
  dispatch(SAVE_SHIPPING_INFO(shipping_info))
